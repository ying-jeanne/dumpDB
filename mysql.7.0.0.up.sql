...
INSERT INTO `user` (`salt` , `company` , `is_admin` , `login` , `password` , `email` , `name` , `rands` , `org_id` , `created` , `updated` , `id` , `version`) SELECT `salt` , `company` , `is_admin` , `login` , `password` , `email` , `name` , `rands` , `account_id` , `created` , `updated` , `id` , `version` FROM `user_v1`
...
INSERT INTO `dashboard` (`title` , `data` , `org_id` , `created` , `updated` , `id` , `version` , `slug`) SELECT `title` , `data` , `account_id` , `created` , `updated` , `id` , `version` , `slug` FROM `dashboard_v1`
...
-- copy data_source v1 to v2
INSERT INTO `data_source` (`version` , `password` , `basic_auth` , `created` , `name` , `basic_auth_password` , `is_default` , `user` , `database` , `basic_auth_user` , `id` , `org_id` , `url` , `type` , `access` , `updated`) SELECT `version` , `password` , `basic_auth` , `created` , `name` , `basic_auth_password` , `is_default` , `user` , `database` , `basic_auth_user` , `id` , `account_id` , `url` , `type` , `access` , `updated` FROM `data_source_v1`
