...
INSERT INTO `user` (`password` , `salt` , `org_id` , `is_admin` , `name` , `rands` , `company` , `created` , `id` , `version` , `login` , `email` , `updated`) SELECT `password` , `salt` , `account_id` , `is_admin` , `name` , `rands` , `company` , `created` , `id` , `version` , `login` , `email` , `updated` FROM `user_v1`
...
INSERT INTO `dashboard_provisioning` (`dashboard_id` , `name` , `external_id` , `id`) SELECT `dashboard_id` , `name` , `external_id` , `id` FROM `dashboard_provisioning_tmp_qwerty`
...
-- copy data_source v1 to v2
INSERT INTO `data_source` (`basic_auth_password` , `is_default` , `created` , `type` , `database` , `basic_auth_user` , `password` , `updated` , `id` , `org_id` , `name` , `url` , `user` , `version` , `access` , `basic_auth`) SELECT `basic_auth_password` , `is_default` , `created` , `type` , `database` , `basic_auth_user` , `password` , `updated` , `id` , `account_id` , `name` , `url` , `user` , `version` , `access` , `basic_auth` FROM `data_source_v1`
